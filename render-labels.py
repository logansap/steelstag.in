...
BASE = Path('/Users/I328057/workspace/Anaishu')
OUT  = BASE / 'print'
OUT.mkdir(exist_ok=True)

# 1px @ 96dpi = 0.2646mm  →  1mm = 3.7795px
...
# Shared CSS (fonts, resets, variables) — same as labels.html
SHARED_CSS = """
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600&family=Oxanium:wght@600;800&display=swap');
...
<svg style="position:absolute;inset:0;width:{total_w}px;height:{total_h}px;pointer-events:none" viewBox="0 0 {total_w} {total_h}">
  <!-- crop marks: 4 corners × 2 lines each, with gap from label edge -->
...
CARE_ICONS_WHITE = """
<!-- Wash 30° — tub with curved bottom -->
<svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.5" style="width:18px;height:18px;opacity:0.65">
  ...
  <text x="12" y="16" text-anchor="middle" font-size="5.5" fill="#fff" stroke="none" font-family="sans-serif">30°</text>
</svg>
...
<!-- Tumble dry — circle with inner circle -->
<svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.5" style="width:18px;height:18px;opacity:0.65">
  <circle cx="12" cy="12" r="9"/>
  <circle cx="12" cy="12" r="4.5"/>
</svg>
<!-- Do not iron — iron shape with X -->
<svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.5" style="width:18px;height:18px;opacity:0.65">
...
<!-- Do not dry clean — circle with P and X -->
<svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.5" style="width:18px;height:18px;opacity:0.65">
  <circle cx="12" cy="12" r="9"/>
...
<!-- Do not iron — iron shape with red X -->
<svg viewBox="0 0 24 24" fill="none" stroke="#444" stroke-width="1.5" style="width:22px;height:22px">
  <path d="M4 17 L4 14 Q4 10 9 10 L20 10 L20 17 Z"/>
  <rect x="9" y="17" width="6" height="2" rx="0.5"/>
  <line x1="6" y1="11.5" x2="18" y2="16.5" stroke="#cc0000" stroke-width="1.8"/>
  <line x1="18" y1="11.5" x2="6" y2="16.5" stroke="#cc0000" stroke-width="1.8"/>
</svg>
<!-- Do not dry clean — circle with P and red X -->
<svg viewBox="0 0 24 24" fill="none" stroke="#444" stroke-width="1.5" style="width:22px;height:22px">
  <circle cx="12" cy="12" r="9"/>
  <text x="12" y="16.5" text-anchor="middle" font-size="9" fill="#444" stroke="none" font-family="serif" font-style="italic">P</text>
  <line x1="4.5" y1="5.5" x2="19.5" y2="18.5" stroke="#cc0000" stroke-width="1.8"/>
</svg>
"""

LABELS = [

  # 1. Neck Labels — 50×30mm, one per size, transparent bg
  *[dict(
  ...
  # 2. Wash Care Label — 40×60mm
  dict(
    name='wash-care-label',
    w=40, h=60, bg='#ffffff',
    css="""
      .label { padding: 12px 10px; gap: 7px; }
      .brand  { font-family: Oxanium, sans-serif; font-weight: 800; font-size: 9px; letter-spacing: 0.15em; color: var(--ink); }
    ...
    html=f"""
      ...
      <div class="div"></div>
      <div class="fabric">100% Organic Cotton<br/>Pre-shrunk</div>
      <div class="div"></div>
  ...
  # 3a–3d. Size Stickers — 30mm circle
  *[dict(
  ...
  dict(
    ...
    html="""
      ...
      <div class="tag-body">
        ...
        <div class="gold-rule"></div>
        <div class="prem-text">Premium Solid Tees<br/>100% Organic Cotton<br/>Made in India</div>
      </div>
      <div class="bottom-bar"><span class="website">steelstag.in</span></div>
    """,
  ),

  # 5. Hang Tag Back — 50×85mm
  dict(
    name='hang-tag-back',
    w=50, h=85, bg='#141414',
    css="""
      ...
      .back-body { flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 14px; padding: 16px 20px; text-align: center; }
      ...
      .back-text { font-size: 5.5px; letter-spacing: 0.18em; text-transform: uppercase; color: rgba(255,255,255,0.3); line-height: 2.2; font-family: Inter, sans-serif; }
      .footer    { font-size: 5px; letter-spacing: 0.15em; color: rgba(255,255,255,0.15); font-family: Inter, sans-serif; }
    """,
    html=f"""
      <div class="hole"></div>
      <div class="back-body">
        ...
        <div class="gold-rule"></div>
        <div class="footer">steelstag.in &nbsp;·&nbsp; © 2026 SteelStag</div>
      </div>
    """,
  ),
]
...
async def render():
    ...
    async with async_playwright() as p:
        ...
        for label in LABELS:
            ...
            path = str(OUT / f"{label['name']}-300dpi.png")
